    ...
    public class LocalizationManager : MonoBehaviour
    {
        ...
        private void InitializeTables()
        {
            ...
            tables[Language.English] = new Dictionary<string, string>
            {
                ...
                ["achievement.EliteControlIII.title"] = "Elite Control III",
                ["achievement.EliteControlIV.title"] = "Elite Control IV",
                ...
                ["achievement.ArcherCleanupI.title"] = "Archer Cleanup I",
                ["achievement.ArcherCleanupII.title"] = "Archer Cleanup II",
                ["achievement.PhalarxBreakerI.title"] = "Phalarx Breaker I",
                ["achievement.PhalarxBreakerII.title"] = "Phalarx Breaker II",
            ...
            tables[Language.Macedonian] = new Dictionary<string, string>
            {
                ...
                ["achievement.EliteControlIII.title"] = "Елитна Контрола III",
                ["achievement.EliteControlIV.title"] = "Елитна Контрола IV",
                ...
                ["achievement.ArcherCleanupI.title"] = "Чистење на Стрелци I",
                ["achievement.ArcherCleanupII.title"] = "Чистење на Стрелци II",
                ["achievement.PhalarxBreakerI.title"] = "Кршач на Фаларкс I",
                ["achievement.PhalarxBreakerII.title"] = "Кршач на Фаларкс II",
                ...
                ["achievement.DoubleDownI.title"] = "Двојно Надолу I",
                ["achievement.DoubleDownII.title"] = "Двојно Надолу II",
