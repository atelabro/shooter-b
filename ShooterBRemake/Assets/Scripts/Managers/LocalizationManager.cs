    ...
    public class LocalizationManager : MonoBehaviour
    {
        ...
        private void InitializeTables()
        {
            ...
            tables[Language.English] = new Dictionary<string, string>
            {
                ...
                ["superweapon.zeus.description"] = "Drag Zeus into battle to call thunder from above. Deals 10 damage to every duck on screen.",
            ...
            tables[Language.Macedonian] = new Dictionary<string, string>
            {
                ...
                ["superweapon.zeus.description"] = "Повлечи го Зевс во битка за гром од небото. Нанесува 10 штета на секоја патка на екранот.",
